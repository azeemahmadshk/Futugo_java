...
@Service
public class BiniApiService {

    private static final Logger LOG = LoggerFactory.getLogger(BiniApiService.class);
    ...
    public BiniApiService(RestTemplate restTemplate, ObjectMapper objectMapper, BiniConfig biniConfig) {
    ...
    public void initLists() throws JsonProcessingException {
        ...
        LOG.info("Fetching lists from BINI...");
        ...
        goodsListMain = objectMapper.readValue(getClsListByEndpoint("GoodsList?retailer=" + biniConfig.getRetailer()), GoodsListMain.class);
        goodsDetailsListMain = objectMapper.readValue(getClsListByEndpoint("GoodsDetailList?retailer=" + biniConfig.getRetailer()), GoodsDetailListMain.class);
        goodsStockListMain = objectMapper.readValue(getClsListByEndpoint("GoodsStockRetailerList?retailer=" + biniConfig.getRetailer()), GoodsStockListMain.class);
        goodsPriceListMain = objectMapper.readValue(getClsListByEndpoint("GoodsPriceList?retailer=" + biniConfig.getRetailer()), GoodsPriceListMain.class);
    ...
    public String postOrder(OrderMain orderMain) {
        ...
        String url = biniConfig.getEndpoint() + "/" + orderSaveEndpoint;
    ...
    private String getClsListByEndpoint(String endpoint) {
        ...
        String url = biniConfig.getEndpoint() + "/" + endpoint;
    ...
    private HttpHeaders createHttpHeaders() {
        ...
        headers.add("Authorization", "Basic " + Base64.getEncoder().encodeToString((biniConfig.getUsername() + ":" + biniConfig.getPass()).getBytes()));
        headers.add("USER_MKT", biniConfig.getUserMkt());
        headers.add("PWD_MKT", biniConfig.getPwdMkt());
        headers.add("DESCRIPTION", biniConfig.getDescription());
        headers.add("LANGUAGE", biniConfig.getLanguage());
